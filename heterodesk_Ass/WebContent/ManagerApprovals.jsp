	          ...
	          success: function(responseData, textStatus, jqXHR) {
	        	  ...
	        	  if(responseData.indexOf("Successfully")!=-1 && val3=="A"){
	        		 ...
	        		 document.getElementById(""+val2+"_ST").innerHTML="Approved";
	        		  document.getElementById(""+val2+"_1").style.display='';
	        		  ...
	        		  document.getElementById(""+val2+"_ST").innerHTML="Rejected";
	        			  ...
	        			  document.getElementById(""+val2+"_ST").innerHTML="Cancelled"; 
	        		  }
								...
								<div class="panel panel-primary">
								   ...
								   <span id='Requ_Date_ERROR' style='color:red;' align='right'> Please Submit your approvals before payroll closing. </span>
									<div class="panel-headingattn">
									  <div class="col-md-3">
										<span><i class="fa fa-calendar fa-lg"></i>&nbsp;Leave Approvals 
													...
													<thead class="thead-default " style="background-color:#f2f2f2; color:#777777;">
														<tr>
														   ...
														   <th class="text-center">No.of Days</th>
															...
															<th class="text-center" colspan='2'>Approve / Reject</th>
