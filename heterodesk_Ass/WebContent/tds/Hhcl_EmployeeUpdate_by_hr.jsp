...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  if(TDS_EMP.equalsIgnoreCase("EMP")){
  ...
  System.out.println("Hhcl_EmployeeUpdate_by_hr.jsp ~~~ BioData at JSP::" +Emp_Payslip);
...
.modal-content {
	...
	<body onload="Bank_Type()"  ng-app="myApp" ng-controller="formCtrl" >
		<section class="body">
							...
							<nav id="menu" class="nav-main" role="navigation">
								...
								<!-- 	
									...
									<li  style='display:{{ HR_LINKS.LINK4 }}' >
									  <a href="Hr_attendance?Routing=Dept_att_HR&atload=first" target="_parent">
									...
									<li  style='display:<%=TDS_EMP %>;' >
									
									  <a  href="PayslipDownload?Routing=TDS" target="_parent" >
										<i class="fa fa-users" ></i>
										<span class="font-bold">Generate TDS</span>
									  </a>
					...
					<div class="container">
						<div class="row " >
							<div class="col-md-10 middle-reg2">
								...
								<iframe src="tds/index.jsp" height="500px" width="930px" scrolling="yes"></iframe>
									...
									<!-- <div class="panel-body"> -->
                                      ...
                                      <!--  <div class="col-md-5" style="margin-top:0px;"> -->
                                       ...
                                       <!-- <div class="form-group" style="margin-left: 0px;"> -->
                                         ...
                                         <!-- <img src="Training-HR.jpg" width='942px'> -->     
    ...
    <button type="submit" class="btn btn-default">Submit</button>
									...
									<div class="col-md-4">
	                                       <div class="form-group" style="margin-left: -110%;">
														<label class="col-md-4 control-label"><span id="textboxname" style="margin-left: -16px;"></span></label>
														<div class="col-md-7" style="margin-left: -129px;width: 42%;">
...
margin-left: -10px;"></textarea>
									...
									<div class="col-md-4">
	                                       <div class="form-group">
														...
														<div class="col-md-9">
																  <select id="state" onchange="StateChange(this.value)" class="form-control"><option value="Select" >--Select One--</option> </select>
