							...
							<div class="col-md-10 middle-reg2">
								<div class="panel panel-danger" >
									<div class="panel-heading1">
										<span><b>Employee Profile Update By HR</b> </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<div class="panel-body">
                                       ...
                                       <div class="form-group" style="margin-left: 22px;">
													...
													<div class="col-md-4" >
										<input type="text" class="form-control " id="EmployeeId" name="EmployeeId"  value='' size='180px'  >
													</div> 
												</div>
    ...
    <button type="submit" class="btn btn-default">Submit</button>
									...
									<div class="col-md-5" style="margin-left: -33%;">
	                                       <div class="form-group">
														...
														<div class="col-md-7" style="margin-left: -55px;width: 64%;">
