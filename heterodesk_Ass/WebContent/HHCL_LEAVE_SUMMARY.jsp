							...
							<div class="col-md-12">
								<div class="panel panel-danger" >
									<div class="panel-heading1">
										<span><b>Leaves Summary Report </b><a href="#"><span class="note" href="src/tooltip-ajax.html" width="320px"  style='cursor:hand;color:red;' onmouseover="tooltip.ajax(this, 'src/tooltip-ajax.html');" onclick="return false;">Note</span></a>
								           ...
								           <!--  <table class="table table-striped">
													...
													<thead class="thead-default text-center">
														...
														<tr >
															...
															<td>Applied:<td> <td>Approved:<td> <td>Reject:<td><td>Pending:<td>
														</tr>
														
														<tr >
															<td>Sick Leaves<td><td>Total:<td> <td>Used:<td> <td>Rem:<td>
															<td>Applied:<td> <td>Approved:<td> <td>Reject:<td><td>Pending:<td>
														</tr>
														...
														<tr >
															<td  >Earned Leaves<td><td>Total:<td> <td>Used:<td> <td>Rem:<td>
															<td>Applied:<td> <td>Approved:<td> <td>Reject:<td><td>Pending:<td>
														</tr>
														
														<tr >
															<td  >COMP-Off<td><td>&nbsp;&nbsp;&nbsp;<td> <td>Used:<td> <td>&nbsp;&nbsp;&nbsp;<td>
															<td>Applied:<td> <td>Approved:<td> <td>Reject:<td><td>Pending:<td>
														</tr>
														
														<tr >
															<td>OnDuty<td><td>&nbsp;&nbsp;&nbsp;<td> <td>Used:<td> <td>&nbsp;&nbsp;<td>
															<td>Applied:<td> <td>Approved:<td> <td>Reject:<td><td>Pending:<td>
														</tr>
