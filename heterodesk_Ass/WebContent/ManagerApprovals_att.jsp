  ...
  function disableBackButton() {
								...
								<div class="panel panel-primary">
								   ...
								   <span id='Requ_Date_ERROR' style='color:red;' align='right'> Please Submit your approvals before payroll closing. </span>
									<div class="panel-headingattn">
									  ...
									  <div class="col-md-3">
										<span><i class="fa fa-calendar fa-lg"></i>&nbsp;Attendance Approvals 
									...
									<div class="panel-body">
										...
										<td class="text-center">	<a href="#"><span    class="red-tooltip"  data-toggle="tooltip" data-placement="bottom" title='{{ x.MESSAGE }} ' > <span class="glyphicon glyphicon-envelope"></span>  </span></a>	</td>		
    ...
    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Hooray!">Right</a></li>
														...
														<!--  <td class="text-center"> <span  id="{{ x.DATE }}_ST" > {{ x.DAREQ }}  </span> </td>  -->
														 ...
														 <td class="text-center" colspan='2'> <input type='button' class='btn btn-primary btn-sm'  name='{{ x.RID }}' alt='{{ x.ID }}' id='{{ x.RID }}_1'   onclick='ICT_Req(this);' value='{{ x.B1T }}' style='display:{{ x.B1 }}'/ > &nbsp; <input type='button' class='btn btn-primary btn-sm'  alt='{{ x.ID }}' name='{{ x.RID }}'  id='{{ x.RID }}_2'   onclick='ICT_Req(this);' value='{{ x.B2T }}' style='display:{{ x.B2 }}'  /> </td> 
