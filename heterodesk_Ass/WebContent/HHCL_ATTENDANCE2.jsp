...
<% 
  ...
  System.out.println("Non - Flexy Policy Page");
			 ...
			 else if(Month_FROM.length>1 && Month_TO.length>1)
				 {
					...
					var Days = (diffDays + 1);
					  if(Days < 0){
						...
						document.getElementById('errMessage').innerHTML='From date should be lessthan To Date';
						 
					  }else if(Days > 60){
						  document.getElementById('errMessage').innerHTML="Please select period of 60 or less than days only";
					return false;
					}
				 }
...
<script>
  function disableBackButton() {
	...
	<body  data-ng-app="myApp" data-ng-controller="formCtrl"  onload="disableBackButton(); noBack();">
		<section class="body">
