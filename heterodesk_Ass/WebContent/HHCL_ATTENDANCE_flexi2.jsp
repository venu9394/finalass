...
<% 
  ...
  System.out.println("ATT_MONTHS~"+ATT_MONTHS);
...
try{
	 $scope.myFunction = function(val) {
		...
		if(val=="My") {
		 ...
		 $http({
		        method : "POST",
		        url : "Attendance_flexi2?Routing=ATTENDANCE_BIO_DATES&ATT_FLAG=MONTHS&Month="+Month_Sel+"&PPWise="+payperiodwise+"",
		...
		if(val=="My_Datas"){
			...
			var Month_Sel="";
			 ...
			 $http({
			        method : "POST",
			        url : "Attendance_flexi2?Routing=ATTENDANCE_BIO_DATES&ATT_FLAG=DATES&Month_FROM="+Month_FROM+"&Month_TO="+Month_TO+" ",
...
<script>
 ...
 <link rel="stylesheet" href="jqueryui_date.css">
		...
		<script src="HR/jquery-ui.js"></script> 
										...
										<div class="col-md-4" style="margin-top:5px;">
										 <select class="select" id="Month_Sel" >
										    <option    value="currmonth"  selected > Current Month </option>
									  		<option  data-ng-repeat="(key, value) in Data_2"  value="{{key}}"  > {{value}} </option>
									  	</select>
												...
												<table class="table table-striped ">
													...
													<tr ng-repeat="x in Data_1"  style="background-color:{{x.DEDCOLOR}}">
														...
														<td align="center"> 
														   ...
														   <input type='button' class="btn btn-primary btn-sm"  name="{{ x.INNER }}" id="{{ x.DATE }}" data-toggle="modal" data-target="#myModal" id="myBtn" ng-click="newICTReq($event);" value='Request' style='display:{{ x.DAF }}'  />
														</td> 
